...
export const FinanceFeature = (props: Layout422Props) => {
    ...
    <section className="px-[5%] py-12">
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <h2 className=" mb-2 h2 text-red-primary">{heading}</h2>
          <p className=" text-txt-primary font-light tracling-wide">
            {description}
          </p>
        </div>
          ...
          {features.map((feature, index) => (
            ...
            >
              <div className="group absolute inset-0 flex size-full flex-col items-center justify-center self-start">
                <div className="absolute inset-0 bg-black/50 opacity-55" />
                <img
              ...
              <div className="group relative flex h-full min-h-[70vh] flex-col justify-end p-6 md:p-8 lg:p-12">
                ...
                <AnimatePresence>
                  {hoveredFeatureIdx === index && (
                    ...
                    >
                      <p className="mt-5 text-white-dark md:mt-6">
                        {feature.description}
                      </p>
...
export const Layout422Defaults: Layout422Props = {
  tagline: "Discover",
  heading: "Welcome to our Automobile Website",
  description:
    "Explore our wide selection of vehicles and find the perfect one for you..",
  features: [
    {
      tagline: "Tagline",
      url: "/finance",
    ...
    },
    {
      tagline: "Tagline",
      url: "/tradein",
      heading: "Trade-In Your Vehicle Today",
      description: "Upgrade to a newer model with our trade-in program.",
      image: {
        src: "/finance2.jpg",
